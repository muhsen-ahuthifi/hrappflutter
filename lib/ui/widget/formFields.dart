...
Widget entryField(String title, FormFieldSetter<String?> onSaveFn, FormFieldValidator<String?> validatorFn,
...
Widget submitButton(BuildContext context, String title,void Function() fun) {
  return InkWell(
    onTap: fun,
    child: Container(
...
Widget smartSubmitButton(BuildContext context, String title,void Function() fun) =>
    new Padding(
