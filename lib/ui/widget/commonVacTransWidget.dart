...
smartBadgLabel(
        String title, String val, CrossAxisAlignment crossAxisAlignment) =>
    Expanded(
      child: Column(
          ...
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontWeight: FontWeight.w500,
                fontSize: 12,
                color: SmartAppTheme.grey.withOpacity(0.8),
              ),
            ),
          ),
        ],
...
smartBadgTitle(String title, String val) => Row(
      mainAxisAlignment: MainAxisAlignment.center,
...
smartVacTransState(bool appreoved, bool reject, String appreoveState) => Column(
      mainAxisAlignment: MainAxisAlignment.center,
...
smartVacSubTitle(String title, String val) => Row(
...
smartVacTypeTitle(String val) => Row(
      children: <Widget>[
        Container(
          height: 20,
          width: 2,
