...
//https://sps.alaman.org/ar/api/
  ...
  static const String PermissionTransPanel =
      baseURL + "/EmpPermissionTransPanel";
  static const String SparePermissionPanel =
      baseURL + "/EmpSparePermissionPanel";
  static const String ManagerPermissionPanel =
      baseURL + "/ManagerPermissionPanel";
  ...
  static const String ManagerVacationTransPost =
      baseURL + "/ManageVacationSync";
  static const String ManagerPermissionTransPost =
      baseURL + "/ManagePermissionSync";
...
//  static const String EmployeeForEvalPanel= baseURL + "/EmployeeForEvalPanel";
  ...
  static const String EmployeeTermEvalPanal =
      baseURL + "/EmployeeTermEvalPanal"; //?evalemp=127
  ...
  static const String EmployeeFilter = baseURL + "/EmployeeFilter?archived=0";

  static const String DocumentTermForEval =
      baseURL + "/EvalDocumentTermForEval";
  static const String EvalPosts = baseURL + "/EvalPostsSyncSimple";

  static const String DepartmentPeriodEvalPanal =
      baseURL + "/EvalByDepartmentPeriodsPanel";
  static const String DepartmentEmpEvalPanal =
      baseURL + "/EvalByDepartmentEmpsPanel";
}
