                ...
                //  const SizedBox(height: 40),
                  Image.asset(
                   ...
                   // scale: 2,
                    ...
                    color:isTimePost ? Colors.orange : SmartAppTheme.colorPrimary,
                  ),
                ExcludeSemantics(
                  child: Text(this.widget.vm.monitortype, style: SmartAppTheme.title),
                ),
                 
                  const SizedBox(height: 5),
                  ExcludeSemantics(
                  child: Text(isTimePost ? "اجازة ساعية" : "اجازة يومية",style: SmartAppTheme.caption),
                ),
