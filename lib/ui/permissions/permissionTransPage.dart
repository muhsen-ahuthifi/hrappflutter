...
class PermissionTransPage extends StatelessWidget {

 const PermissionTransPage({super.key});
 ...
 @override
  Widget build(BuildContext context) {
   return NgListView(
      dataLoader: (context) =>fetchPanelData(AppUrl.PermissionTransPanel,
        (row) => new PermissionTransPanel.fromJson(row)) ,
...
Widget _buildRow(BuildContext context,PermissionTransPanel row) {
 return _ListRowView(
              data: row,
              callback: () {
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          smartVacTransState(data.appreoved, data.req_reject,
                              data.appreoveState),
                        ],
                      ),
